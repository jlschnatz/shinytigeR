...
#'
#' @noRd
# mod_progress_dashboard_server <- function(id, feedback_data, bearbeitet, all_data, credentials) {
...
#         p1 <- suppressWarnings(ggplot(all_data, aes(x = Lerneinheit, y = theta, color = Lerneinheit)) +
